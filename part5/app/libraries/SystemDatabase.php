...
require_once "../app/config/config.php";
 ...
 class SystemDatabase{
    ...
    public function dbexecute(){
      ...
      //get all results as array assoc
    ...
    public function getmultidataobj(){
        ...
        return $this->stmt->fetchAll(PDO::FETCH_OBJ); //Laravel style
    }
    ...
    public function getsingledataassoc(){
       ...
       //get single result as as obj array 
       public function getsingledataobj(){
        $this->dbexecute();
 
        return $this->stmt->fetch(PDO::FETCH_OBJ); //Laravel style
    }

    // getdatabase row count 
