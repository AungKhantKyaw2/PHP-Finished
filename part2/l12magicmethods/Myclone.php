...
class Myclone{
      ...
      {
        echo "You not yet define these \"${method}\" non-satatic method. so your value are = "."<pre>"  . print_r($vals,true)."</pre>";
      }
      ...
      {
        echo "You not yet define these \"${method}\" static method. so your value are = "."<pre>"  . print_r($vals,true)."</pre>";
      }
